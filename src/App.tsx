...
export default function App() {
  ...
  return (<>
    ...
    <div className="App">
      ...
      <div>
        {uiState === UIState.Start && <StartPage setPlans={setPlans} setPlansIdsId={setPlansIdsId} setTasksIdsId={setTasksIdsId} onNextPressed={() => setUIState(UIState.Plan)} />}
        {uiState === UIState.Plan && <PlanPage plans={plans} plansIdsId={plansIdsId} tasksIdsId={tasksIdsId} onBackPressed={() => setUIState(UIState.Start)} onNextPressed={() => setUIState(UIState.Record)} />}
        {uiState === UIState.Record && <RecordPage day={day} setDay={setDay} onNextPressed={() => setUIState(UIState.Progress)} />}
